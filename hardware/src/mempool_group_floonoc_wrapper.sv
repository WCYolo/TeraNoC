...
#(
  ...
  // feedthrough ports for req & resp
  input  floo_tcdm_req_if_t [West:North] ft_tcdm_req_i,
  output floo_tcdm_req_if_t [West:North] ft_tcdm_req_o,

  input  floo_tcdm_rsp_if_t [West:North] ft_tcdm_rsp_i,
  output floo_tcdm_rsp_if_t [West:North] ft_tcdm_rsp_o,

  input  tcdm_adapter_cfg_t              tcdm_adapter_cfg_i
...
for (genvar j = 0; j < NumTilesPerGroup; j++) begin : gen_tcdm_wide_req_adapt_j
  for (genvar k = 0; k < NumWideRemoteReqPortsPerTile; k++) begin : gen_tcdm_wide_req_adapt_k
    ...
    assign ft_req_ew_pipe_en =
        (tcdm_adapter_cfg_i.ew == TCDM_AXIS_DEFAULT) ||
        (tcdm_adapter_cfg_i.ew == TCDM_AXIS_SWAP_DATA_PASS_FT);

    logic ft_req_ns_pipe_en;
    assign ft_req_ns_pipe_en =
        (tcdm_adapter_cfg_i.ns == TCDM_AXIS_DEFAULT) ||
        (tcdm_adapter_cfg_i.ns == TCDM_AXIS_SWAP_DATA_PASS_FT);
    ...
    tcdm_ft_pipe #(
      ...
      .clk_i,
      .rst_ni,
      .data_i  (ft_tcdm_req_i[West].floo_tcdm_req[j].wide_req[k].req),
      .valid_i (ft_tcdm_req_i[West].floo_tcdm_req[j].wide_req[k].valid & ft_req_ew_pipe_en),
    ...
    tcdm_ft_pipe #(
      ...
      .clk_i,
      .rst_ni,
      .data_i  (ft_tcdm_req_i[East].floo_tcdm_req[j].wide_req[k].req),
      .valid_i (ft_tcdm_req_i[East].floo_tcdm_req[j].wide_req[k].valid & ft_req_ew_pipe_en),
    ...
    floo_tcdm_rdwr_req_t ft_req_s2n_data;
    logic ft_req_s2n_valid, ft_req_s2n_ready_i, ft_req_s2n_ready_o;
    ...
    tcdm_ft_pipe #(
      ...
      .clk_i,
      .rst_ni,
      .data_i  (ft_tcdm_req_i[South].floo_tcdm_req[j].wide_req[k].req),
      .valid_i (ft_tcdm_req_i[South].floo_tcdm_req[j].wide_req[k].valid & ft_req_ns_pipe_en),
      .ready_o (ft_req_s2n_ready_o),
      .data_o  (ft_req_s2n_data),
      .valid_o (ft_req_s2n_valid),
      .ready_i (ft_req_s2n_ready_i)
    );

    floo_tcdm_rdwr_req_t ft_req_n2s_data;
    logic ft_req_n2s_valid, ft_req_n2s_ready_i, ft_req_n2s_ready_o;
    ...
    tcdm_ft_pipe #(
      ...
      .clk_i,
      .rst_ni,
      .data_i  (ft_tcdm_req_i[North].floo_tcdm_req[j].wide_req[k].req),
      .valid_i (ft_tcdm_req_i[North].floo_tcdm_req[j].wide_req[k].valid & ft_req_ns_pipe_en),
      .ready_o (ft_req_n2s_ready_o),
      .data_o  (ft_req_n2s_data),
      .valid_o (ft_req_n2s_valid),
      .ready_i (ft_req_n2s_ready_i)
    );
    ...
    always_comb begin
      ...
      ft_tcdm_req_o[West ].floo_tcdm_req[j].wide_req[k] = '0;
      ft_tcdm_req_o[East ].floo_tcdm_req[j].wide_req[k] = '0;
      ft_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k] = '0;
      ft_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k] = '0;
      ...
      ft_req_s2n_ready_i = 1'b0;
      ft_req_n2s_ready_i = 1'b0;

      unique case (tcdm_adapter_cfg_i.ew) //to be mutually exclusive
        TCDM_AXIS_DEFAULT: begin
          ...
          // feedthrough pass
          // ft_tcdm_req_o[East].floo_tcdm_req[j].wide_req[k] = ft_tcdm_req_i[West].floo_tcdm_req[j].wide_req[k];
          // ft_tcdm_req_o[West].floo_tcdm_req[j].wide_req[k] = ft_tcdm_req_i[East].floo_tcdm_req[j].wide_req[k];

          ft_tcdm_req_o[East].floo_tcdm_req[j].wide_req[k].req      = ft_req_w2e_data;
          ft_tcdm_req_o[East].floo_tcdm_req[j].wide_req[k].valid    = ft_req_w2e_valid;
          ft_req_w2e_ready_i                                        = ft_tcdm_req_i[East].floo_tcdm_req[j].wide_req[k].ready;
          ft_tcdm_req_o[West].floo_tcdm_req[j].wide_req[k].ready    = ft_req_w2e_ready_o;

          ft_tcdm_req_o[West].floo_tcdm_req[j].wide_req[k].req      = ft_req_e2w_data;
          ft_tcdm_req_o[West].floo_tcdm_req[j].wide_req[k].valid    = ft_req_e2w_valid;
          ft_req_e2w_ready_i                                        = ft_tcdm_req_i[West].floo_tcdm_req[j].wide_req[k].ready;
          ft_tcdm_req_o[East].floo_tcdm_req[j].wide_req[k].ready    = ft_req_e2w_ready_o;
        end
        ...
        TCDM_AXIS_SIDE0_EDGE_BRIDGE: begin
          ...
          ft_tcdm_req_o[East].floo_tcdm_req[j].wide_req[k].req     = floo_tcdm_wide_req_out[West][j][k];
          ft_tcdm_req_o[East].floo_tcdm_req[j].wide_req[k].valid   = floo_tcdm_wide_req_valid_out[West][j][k];
          floo_tcdm_wide_req_ready_in[West][j][k]                  = ft_tcdm_req_i[East].floo_tcdm_req[j].wide_req[k].ready;

          //ft East in -> router West in
          floo_tcdm_wide_req_in[West][j][k]                        = ft_tcdm_req_i[East].floo_tcdm_req[j].wide_req[k].req;
          floo_tcdm_wide_req_valid_in[West][j][k]                  = ft_tcdm_req_i[East].floo_tcdm_req[j].wide_req[k].valid;
          ft_tcdm_req_o[East].floo_tcdm_req[j].wide_req[k].ready   = floo_tcdm_wide_req_ready_out[West][j][k];
        ...
        TCDM_AXIS_SIDE1_EDGE_BRIDGE: begin
          ...
          ft_tcdm_req_o[West].floo_tcdm_req[j].wide_req[k].req     = floo_tcdm_wide_req_out[East][j][k];
          ft_tcdm_req_o[West].floo_tcdm_req[j].wide_req[k].valid   = floo_tcdm_wide_req_valid_out[East][j][k];
          floo_tcdm_wide_req_ready_in[East][j][k]                  = ft_tcdm_req_i[West].floo_tcdm_req[j].wide_req[k].ready;

          // ft West in -> router East in
          floo_tcdm_wide_req_in[East][j][k]                        = ft_tcdm_req_i[West].floo_tcdm_req[j].wide_req[k].req;
          floo_tcdm_wide_req_valid_in[East][j][k]                  = ft_tcdm_req_i[West].floo_tcdm_req[j].wide_req[k].valid;
          ft_tcdm_req_o[West].floo_tcdm_req[j].wide_req[k].ready   = floo_tcdm_wide_req_ready_out[East][j][k];
      ...
      // Add the NS case below with side0 = South, side1 = North.
      unique case (tcdm_adapter_cfg_i.ns)
        TCDM_AXIS_DEFAULT: begin
          // router South out -> data South out
          ...
          // router North out -> data North out
          ...
          // data South/North in -> router South/North in
          ...
          // feedthrough pass
          // ft_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k] = ft_tcdm_req_i[South].floo_tcdm_req[j].wide_req[k];
          // ft_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k] = ft_tcdm_req_i[North].floo_tcdm_req[j].wide_req[k];

          ft_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k].req     = ft_req_s2n_data;
          ft_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k].valid   = ft_req_s2n_valid;
          ft_req_s2n_ready_i                                        = ft_tcdm_req_i[North].floo_tcdm_req[j].wide_req[k].ready;
          ft_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k].ready   = ft_req_s2n_ready_o;

          ft_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k].req     = ft_req_n2s_data;
          ft_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k].valid   = ft_req_n2s_valid;
          ft_req_n2s_ready_i                                        = ft_tcdm_req_i[South].floo_tcdm_req[j].wide_req[k].ready;
          ft_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k].ready   = ft_req_n2s_ready_o;
        end

        TCDM_AXIS_SWAP_DATA_PASS_FT: begin
          // router South out -> data North out
          floo_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k].req   = floo_tcdm_wide_req_out[South][j][k];
          floo_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k].valid = floo_tcdm_wide_req_valid_out[South][j][k];
          floo_tcdm_wide_req_ready_in[South][j][k]                  = floo_tcdm_req_i[North].floo_tcdm_req[j].wide_req[k].ready;

          // router North out -> data South out
          floo_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k].req   = floo_tcdm_wide_req_out[North][j][k];
          floo_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k].valid = floo_tcdm_wide_req_valid_out[North][j][k];
          floo_tcdm_wide_req_ready_in[North][j][k]                  = floo_tcdm_req_i[South].floo_tcdm_req[j].wide_req[k].ready;

          // data North in -> router South in
          floo_tcdm_wide_req_in[South][j][k]                       = floo_tcdm_req_i[North].floo_tcdm_req[j].wide_req[k].req;
          floo_tcdm_wide_req_valid_in[South][j][k]                 = floo_tcdm_req_i[North].floo_tcdm_req[j].wide_req[k].valid;
          floo_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k].ready= floo_tcdm_wide_req_ready_out[South][j][k];

          // data South in -> router North in
          floo_tcdm_wide_req_in[North][j][k]                       = floo_tcdm_req_i[South].floo_tcdm_req[j].wide_req[k].req;
          floo_tcdm_wide_req_valid_in[North][j][k]                  = floo_tcdm_req_i[South].floo_tcdm_req[j].wide_req[k].valid;
          floo_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k].ready = floo_tcdm_wide_req_ready_out[North][j][k];
        ...
        TCDM_AXIS_SIDE0_EDGE_BRIDGE: begin
          ...
          // router South out -> ft North out
          ft_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k].req     = floo_tcdm_wide_req_out[South][j][k];
          ft_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k].valid   = floo_tcdm_wide_req_valid_out[South][j][k];
          floo_tcdm_wide_req_ready_in[South][j][k]                  = ft_tcdm_req_i[North].floo_tcdm_req[j].wide_req[k].ready;

          // ft North in -> router South in
          floo_tcdm_wide_req_in[South][j][k]                        = ft_tcdm_req_i[North].floo_tcdm_req[j].wide_req[k].req;
          floo_tcdm_wide_req_valid_in[South][j][k]                  = ft_tcdm_req_i[North].floo_tcdm_req[j].wide_req[k].valid;
          ft_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k].ready   = floo_tcdm_wide_req_ready_out[South][j][k];

          // default side: router North out -> data North out
          floo_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k].req   = floo_tcdm_wide_req_out[North][j][k];
          floo_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k].valid = floo_tcdm_wide_req_valid_out[North][j][k];
          floo_tcdm_wide_req_ready_in[North][j][k]                  = floo_tcdm_req_i[North].floo_tcdm_req[j].wide_req[k].ready;

          // default side: data North in -> router North in
          floo_tcdm_wide_req_in[North][j][k]                        = floo_tcdm_req_i[North].floo_tcdm_req[j].wide_req[k].req;
          floo_tcdm_wide_req_valid_in[North][j][k]                  = floo_tcdm_req_i[North].floo_tcdm_req[j].wide_req[k].valid;
          floo_tcdm_req_o[North].floo_tcdm_req[j].wide_req[k].ready = floo_tcdm_wide_req_ready_out[North][j][k];
        end
        ...
        TCDM_AXIS_SIDE1_EDGE_BRIDGE: begin
          // NS side0 = South, side1 = North.
          // router North out -> ft South out
          ft_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k].req     = floo_tcdm_wide_req_out[North][j][k];
          ft_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k].valid   = floo_tcdm_wide_req_valid_out[North][j][k];
          floo_tcdm_wide_req_ready_in[North][j][k]                  = ft_tcdm_req_i[South].floo_tcdm_req[j].wide_req[k].ready;

          // ft South in -> router North in
          floo_tcdm_wide_req_in[North][j][k]                        = ft_tcdm_req_i[South].floo_tcdm_req[j].wide_req[k].req;
          floo_tcdm_wide_req_valid_in[North][j][k]                  = ft_tcdm_req_i[South].floo_tcdm_req[j].wide_req[k].valid;
          ft_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k].ready   = floo_tcdm_wide_req_ready_out[North][j][k];

          // default side: router South out -> data South out
          floo_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k].req   = floo_tcdm_wide_req_out[South][j][k];
          floo_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k].valid = floo_tcdm_wide_req_valid_out[South][j][k];
          floo_tcdm_wide_req_ready_in[South][j][k]                  = floo_tcdm_req_i[South].floo_tcdm_req[j].wide_req[k].ready;

          // default side: data South in -> router South in
          floo_tcdm_wide_req_in[South][j][k]                        = floo_tcdm_req_i[South].floo_tcdm_req[j].wide_req[k].req;
          floo_tcdm_wide_req_valid_in[South][j][k]                  = floo_tcdm_req_i[South].floo_tcdm_req[j].wide_req[k].valid;
          floo_tcdm_req_o[South].floo_tcdm_req[j].wide_req[k].ready = floo_tcdm_wide_req_ready_out[South][j][k];
        end
...
for (genvar j = 0; j < NumTilesPerGroup; j++) begin : gen_tcdm_resp_adapt_j
  for (genvar k = 1; k < NumRemoteRespPortsPerTile; k++) begin : gen_tcdm_resp_adapt_k
    ...
    logic ft_rsp_ns_pipe_en;
    assign ft_rsp_ns_pipe_en =
        (tcdm_adapter_cfg_i.ns == TCDM_AXIS_DEFAULT) ||
        (tcdm_adapter_cfg_i.ns == TCDM_AXIS_SWAP_DATA_PASS_FT);

    floo_tcdm_resp_t ft_rsp_w2e_data, ft_rsp_e2w_data, ft_rsp_s2n_data, ft_rsp_n2s_data;
    logic ft_rsp_w2e_valid, ft_rsp_w2e_ready_i, ft_rsp_w2e_ready_o;
    logic ft_rsp_e2w_valid, ft_rsp_e2w_ready_i, ft_rsp_e2w_ready_o;
    logic ft_rsp_s2n_valid, ft_rsp_s2n_ready_i, ft_rsp_s2n_ready_o;
    logic ft_rsp_n2s_valid, ft_rsp_n2s_ready_i, ft_rsp_n2s_ready_o;

    tcdm_ft_pipe #(.payload_t(floo_tcdm_resp_t), .NumStages(2)) i_ft_rsp_w2e_pipe (
      .clk_i, .rst_ni,
      .data_i(ft_tcdm_rsp_i[West].floo_tcdm_resp[j][k].resp),
      .valid_i(ft_tcdm_rsp_i[West].floo_tcdm_resp[j][k].valid & ft_rsp_ew_pipe_en),
    ...
    tcdm_ft_pipe #(.payload_t(floo_tcdm_resp_t), .NumStages(2)) i_ft_rsp_e2w_pipe (
      .clk_i, .rst_ni,
      .data_i(ft_tcdm_rsp_i[East].floo_tcdm_resp[j][k].resp),
      .valid_i(ft_tcdm_rsp_i[East].floo_tcdm_resp[j][k].valid & ft_rsp_ew_pipe_en),
    ...
    tcdm_ft_pipe #(.payload_t(floo_tcdm_resp_t), .NumStages(2)) i_ft_rsp_s2n_pipe (
      .clk_i, .rst_ni,
      .data_i(ft_tcdm_rsp_i[South].floo_tcdm_resp[j][k].resp),
      .valid_i(ft_tcdm_rsp_i[South].floo_tcdm_resp[j][k].valid & ft_rsp_ns_pipe_en),
      .ready_o(ft_rsp_s2n_ready_o),
      .data_o(ft_rsp_s2n_data),
      .valid_o(ft_rsp_s2n_valid),
      .ready_i(ft_rsp_s2n_ready_i)
    );

    tcdm_ft_pipe #(.payload_t(floo_tcdm_resp_t), .NumStages(2)) i_ft_rsp_n2s_pipe (
      .clk_i, .rst_ni,
      .data_i(ft_tcdm_rsp_i[North].floo_tcdm_resp[j][k].resp),
      .valid_i(ft_tcdm_rsp_i[North].floo_tcdm_resp[j][k].valid & ft_rsp_ns_pipe_en),
      .ready_o(ft_rsp_n2s_ready_o),
      .data_o(ft_rsp_n2s_data),
      .valid_o(ft_rsp_n2s_valid),
      .ready_i(ft_rsp_n2s_ready_i)
    );
    ...
    always_comb begin
      ...
      ft_tcdm_rsp_o[West ].floo_tcdm_resp[j][k] = '0;
      ft_tcdm_rsp_o[East ].floo_tcdm_resp[j][k] = '0;
      ft_tcdm_rsp_o[South].floo_tcdm_resp[j][k] = '0;
      ft_tcdm_rsp_o[North].floo_tcdm_resp[j][k] = '0;
      ...
      ft_rsp_s2n_ready_i = 1'b0;
      ft_rsp_n2s_ready_i = 1'b0;
      ...
      unique case (tcdm_adapter_cfg_i.ew) //to be mutually exclusive
        TCDM_AXIS_DEFAULT: begin
          ...
          // feedthrough pass
          // ft_tcdm_rsp_o[East].floo_tcdm_resp[j][k] = ft_tcdm_rsp_i[West].floo_tcdm_resp[j][k];
          // ft_tcdm_rsp_o[West].floo_tcdm_resp[j][k] = ft_tcdm_rsp_i[East].floo_tcdm_resp[j][k];
          ft_tcdm_rsp_o[East].floo_tcdm_resp[j][k].resp  = ft_rsp_w2e_data;
          ft_tcdm_rsp_o[East].floo_tcdm_resp[j][k].valid = ft_rsp_w2e_valid;
          ft_rsp_w2e_ready_i                             = ft_tcdm_rsp_i[East].floo_tcdm_resp[j][k].ready;
          ft_tcdm_rsp_o[West].floo_tcdm_resp[j][k].ready = ft_rsp_w2e_ready_o;

          ft_tcdm_rsp_o[West].floo_tcdm_resp[j][k].resp  = ft_rsp_e2w_data;
          ft_tcdm_rsp_o[West].floo_tcdm_resp[j][k].valid = ft_rsp_e2w_valid;
          ft_rsp_e2w_ready_i                             = ft_tcdm_rsp_i[West].floo_tcdm_resp[j][k].ready;
          ft_tcdm_rsp_o[East].floo_tcdm_resp[j][k].ready = ft_rsp_e2w_ready_o;
        ...
        TCDM_AXIS_SIDE0_EDGE_BRIDGE: begin
          // EW side0 = West, side1 = East.
          // router West out -> ft East out
          ft_tcdm_rsp_o[East].floo_tcdm_resp[j][k].resp   = floo_tcdm_resp_out[West][j][k];
          ft_tcdm_rsp_o[East].floo_tcdm_resp[j][k].valid  = floo_tcdm_resp_valid_out[West][j][k];
          floo_tcdm_resp_ready_in[West][j][k]             = ft_tcdm_rsp_i[East].floo_tcdm_resp[j][k].ready;

          // ft East in -> router West in
          floo_tcdm_resp_in[West][j][k]                   = ft_tcdm_rsp_i[East].floo_tcdm_resp[j][k].resp;
          floo_tcdm_resp_valid_in[West][j][k]             = ft_tcdm_rsp_i[East].floo_tcdm_resp[j][k].valid;
          ft_tcdm_rsp_o[East].floo_tcdm_resp[j][k].ready  = floo_tcdm_resp_ready_out[West][j][k];
        ...
        TCDM_AXIS_SIDE1_EDGE_BRIDGE: begin
          // EW side0 = West, side1 = East.
          // router East out -> ft West out
          ft_tcdm_rsp_o[West].floo_tcdm_resp[j][k].resp   = floo_tcdm_resp_out[East][j][k];
          ft_tcdm_rsp_o[West].floo_tcdm_resp[j][k].valid  = floo_tcdm_resp_valid_out[East][j][k];
          floo_tcdm_resp_ready_in[East][j][k]             = ft_tcdm_rsp_i[West].floo_tcdm_resp[j][k].ready;

          // ft West in -> router East in
          floo_tcdm_resp_in[East][j][k]                   = ft_tcdm_rsp_i[West].floo_tcdm_resp[j][k].resp;
          floo_tcdm_resp_valid_in[East][j][k]             = ft_tcdm_rsp_i[West].floo_tcdm_resp[j][k].valid;
          ft_tcdm_rsp_o[West].floo_tcdm_resp[j][k].ready  = floo_tcdm_resp_ready_out[East][j][k];
      ...
      unique case (tcdm_adapter_cfg_i.ns)
        TCDM_AXIS_DEFAULT: begin
          ...
          // feedthrough pass
          // ft_tcdm_rsp_o[North].floo_tcdm_resp[j][k] = ft_tcdm_rsp_i[South].floo_tcdm_resp[j][k];
          // ft_tcdm_rsp_o[South].floo_tcdm_resp[j][k] = ft_tcdm_rsp_i[North].floo_tcdm_resp[j][k];
          ft_tcdm_rsp_o[North].floo_tcdm_resp[j][k].resp  = ft_rsp_s2n_data;
          ft_tcdm_rsp_o[North].floo_tcdm_resp[j][k].valid = ft_rsp_s2n_valid;
          ft_rsp_s2n_ready_i                              = ft_tcdm_rsp_i[North].floo_tcdm_resp[j][k].ready;
          ft_tcdm_rsp_o[South].floo_tcdm_resp[j][k].ready = ft_rsp_s2n_ready_o;

          ft_tcdm_rsp_o[South].floo_tcdm_resp[j][k].resp  = ft_rsp_n2s_data;
          ft_tcdm_rsp_o[South].floo_tcdm_resp[j][k].valid = ft_rsp_n2s_valid;
          ft_rsp_n2s_ready_i                              = ft_tcdm_rsp_i[South].floo_tcdm_resp[j][k].ready;
          ft_tcdm_rsp_o[North].floo_tcdm_resp[j][k].ready = ft_rsp_n2s_ready_o;
        end

        TCDM_AXIS_SWAP_DATA_PASS_FT: begin
          // router South out -> data North out
          floo_tcdm_rsp_o[North].floo_tcdm_resp[j][k].resp   = floo_tcdm_resp_out[South][j][k];
          floo_tcdm_rsp_o[North].floo_tcdm_resp[j][k].valid  = floo_tcdm_resp_valid_out[South][j][k];
          floo_tcdm_resp_ready_in[South][j][k]               = floo_tcdm_rsp_i[North].floo_tcdm_resp[j][k].ready;

          // router North out -> data South out
          floo_tcdm_rsp_o[South].floo_tcdm_resp[j][k].resp   = floo_tcdm_resp_out[North][j][k];
          floo_tcdm_rsp_o[South].floo_tcdm_resp[j][k].valid  = floo_tcdm_resp_valid_out[North][j][k];
          floo_tcdm_resp_ready_in[North][j][k]               = floo_tcdm_rsp_i[South].floo_tcdm_resp[j][k].ready;

          // data North in -> router South in
          floo_tcdm_resp_in[South][j][k]                     = floo_tcdm_rsp_i[North].floo_tcdm_resp[j][k].resp;
          floo_tcdm_resp_valid_in[South][j][k]               = floo_tcdm_rsp_i[North].floo_tcdm_resp[j][k].valid;
          floo_tcdm_rsp_o[North].floo_tcdm_resp[j][k].ready  = floo_tcdm_resp_ready_out[South][j][k];

          // data South in -> router North in
          floo_tcdm_resp_in[North][j][k]                     = floo_tcdm_rsp_i[South].floo_tcdm_resp[j][k].resp;
          floo_tcdm_resp_valid_in[North][j][k]               = floo_tcdm_rsp_i[South].floo_tcdm_resp[j][k].valid;
          floo_tcdm_rsp_o[South].floo_tcdm_resp[j][k].ready  = floo_tcdm_resp_ready_out[North][j][k];
        ...
        TCDM_AXIS_SIDE0_EDGE_BRIDGE: begin
          // NS side0 = South, side1 = North.
          // router South out -> ft North out
          ft_tcdm_rsp_o[North].floo_tcdm_resp[j][k].resp   = floo_tcdm_resp_out[South][j][k];
          ft_tcdm_rsp_o[North].floo_tcdm_resp[j][k].valid  = floo_tcdm_resp_valid_out[South][j][k];
          floo_tcdm_resp_ready_in[South][j][k]             = ft_tcdm_rsp_i[North].floo_tcdm_resp[j][k].ready;

          // ft North in -> router South in
          floo_tcdm_resp_in[South][j][k]                   = ft_tcdm_rsp_i[North].floo_tcdm_resp[j][k].resp;
          floo_tcdm_resp_valid_in[South][j][k]             = ft_tcdm_rsp_i[North].floo_tcdm_resp[j][k].valid;
          ft_tcdm_rsp_o[North].floo_tcdm_resp[j][k].ready  = floo_tcdm_resp_ready_out[South][j][k];
        ...
        TCDM_AXIS_SIDE1_EDGE_BRIDGE: begin
          // NS side0 = South, side1 = North.
          // router North out -> ft South out
          ft_tcdm_rsp_o[South].floo_tcdm_resp[j][k].resp   = floo_tcdm_resp_out[North][j][k];
          ft_tcdm_rsp_o[South].floo_tcdm_resp[j][k].valid  = floo_tcdm_resp_valid_out[North][j][k];
          floo_tcdm_resp_ready_in[North][j][k]             = ft_tcdm_rsp_i[South].floo_tcdm_resp[j][k].ready;

          // ft South in -> router North in
          floo_tcdm_resp_in[North][j][k]                   = ft_tcdm_rsp_i[South].floo_tcdm_resp[j][k].resp;
          floo_tcdm_resp_valid_in[North][j][k]             = ft_tcdm_rsp_i[South].floo_tcdm_resp[j][k].valid;
          ft_tcdm_rsp_o[South].floo_tcdm_resp[j][k].ready  = floo_tcdm_resp_ready_out[North][j][k];
